...
const audience = [
  ...
  "Ιδιώτες",
  "Νέες ενάρξεις δραστηριότητας",
];

const whenToContact = [
  "Όταν ξεκινάτε νέα δραστηριότητα ή επιχείρηση",
  "Όταν χρειάζεστε φορολογική δήλωση",
  "Όταν θέλετε καλύτερη λογιστική παρακολούθηση",
  "Όταν χρειάζεστε υποστήριξη με myDATA, ΦΠΑ ή μισθοδοσία",
];
