...
const steps = [
  ...
  },
  {
    ...
    desc: "Εξετάζουμε το αίτημα και καθορίζουμε τα επόμενα βήματα.",
  },
  {
    num: 3,
    icon: PhoneCall,
    title: "Επικοινωνούμε μαζί σας",
    desc: "Επικοινωνούμε μαζί σας για διευκρινίσεις και σαφείς οδηγίες.",
  },
  {
    num: 4,
    icon: FolderCheck,
    title: "Συγκεντρώνουμε τα στοιχεία",
    desc: "Ζητάμε τα σωστά δικαιολογητικά και τις πληροφορίες που χρειάζονται για την περίπτωσή σας.",
  },
  {
    num: 5,
    icon: Handshake,
    title: "Ξεκινάμε την υποστήριξη",
    desc: "Συνεχίζουμε με καθαρή επικοινωνία και συνεπή παρακολούθηση των υποχρεώσεών σας.",
  },
];
      ...
      <div className="container-main">
        ...
        >
          ...
          <p className="mt-4 text-[#64748B] leading-relaxed">
            Απλή διαδικασία, καθαρά βήματα και άμεση επικοινωνία μαζί σας.
          </p>
        </motion.div>
