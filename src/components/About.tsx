        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="mt-6 space-y-4 text-[#64748B] leading-relaxed">
              <p>
                Ένα λογιστικό γραφείο που λειτουργεί με υπευθυνότητα, συνέπεια
                και προσωπική σχέση με κάθε πελάτη.
              </p>
              <p>
                Δεν αρκεί να βγαίνουν οι δηλώσεις στην ώρα τους· σημασία έχει να
                καταλαβαίνετε τι γίνεται και να μη σας προλαβαίνουν οι προθεσμίες.
              </p>
              <p>
                Η φόρμα βοηθά στην αρχική καταγραφή, αλλά η συνεργασία παραμένει
                προσωπική: μετά την υποβολή, γίνεται επικοινωνία για διευκρινίσεις
                και οδηγίες.
              </p>
            </div>
          </motion.div>
