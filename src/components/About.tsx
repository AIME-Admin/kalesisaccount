        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="mt-6 space-y-4 text-[#64748B] leading-relaxed">
              <p>
                Υποστηρίζουμε επιχειρήσεις, ελεύθερους επαγγελματίες και ιδιώτες
                σε λογιστικές και φοροτεχνικές ανάγκες, με υπευθυνότητα και
                συνέπεια.
              </p>
              <p>
                Η προσέγγισή μας βασίζεται στην καθαρή επικοινωνία, την
                οργανωμένη συγκέντρωση στοιχείων και την προσεκτική παρακολούθηση
                των υποχρεώσεων κάθε πελάτη.
              </p>
              <p>
                Με τη φόρμα ενδιαφέροντος, η αρχική καταγραφή γίνεται πιο απλή
                και πιο δομημένη, ώστε ο Φίλιππος να έχει καθαρή εικόνα πριν την
