...
const benefits = [
  {
    ...
    desc: "Έχουμε από την αρχή όσα χρειάζονται, χωρίς αλλεπάλληλα μηνύματα.",
  },
  {
    icon: Clock,
    title: "Πιο γρήγορη κατανόηση",
    desc: "Βλέπουμε αμέσως τι ζητάτε και ποια υπηρεσία αφορά.",
  },
  {
    icon: CheckCircle,
    title: "Σωστά δικαιολογητικά",
    desc: "Σας ζητάμε εξαρχής τα σωστά έγγραφα, χωρίς διπλές διαδρομές.",
  },
  {
    icon: MessageCircle,
    title: "Πιο ουσιαστική πρώτη επαφή",
    desc: "Όταν μιλήσουμε, η κουβέντα είναι συγκεκριμένη και χρήσιμη.",
  },
];
      ...
      <div className="container-main">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start max-w-5xl mx-auto">
          ...
          >
            ...
            <h2 className="text-[#111827] mt-3">Πείτε μας τι χρειάζεστε</h2>
            <p className="mt-4 text-[#64748B] leading-relaxed">
              Συμπληρώστε τα βασικά και αναλαμβάνουμε εμείς από εκεί. Όσο πιο
              καθαρό το αίτημα, τόσο πιο γρήγορη η απάντησή μας.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-[#64748B] mb-5">
                Λίγα λεπτά για να μας πείτε τι χρειάζεστε.
              </p>
